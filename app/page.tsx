        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg sm:text-xl lg:text-2xl text-gray-600 dark:text-gray-300 mb-8 md:mb-10 leading-relaxed font-light">
            ...
            >
              ...
              >
                <div className="text-center mb-6 sm:mb-8">
                  <motion.div 
                    className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-teal-500 to-blue-600 rounded-3xl flex items-center justify-center mx-auto mb-4 sm:mb-6 shadow-xl"
                    whileHover={{ rotate: 10 }}
                  >
                    <span className="text-white font-bold text-xl sm:text-2xl">Dr</span>
                  </motion.div>
                  <p className="text-teal-600 font-semibold text-lg">OB-GYN Specialist</p>
                ...
                <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                  {[
                    { text: "Complete OB-GYN Examination", icon: Stethoscope },
      ...
      <section className="py-16 md:py-24 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            {[
              { icon: Stethoscope, title: "Medical Examination", desc: "Complete OB-GYN examination by licensed physician", gradient: "from-blue-500 to-blue-600", bg: "from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20" },
              ...
              { icon: Baby, title: "Pregnancy Care", desc: "Specialized care for expecting mothers", gradient: "from-pink-500 to-pink-600", bg: "from-pink-50 to-pink-100 dark:from-pink-900/20 dark:to-pink-800/20" }
            ].map((service, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 50 }}
